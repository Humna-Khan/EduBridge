...
import { AnnouncementList } from "@/components/dashboard/announcements/announcement-list"

interface ProgramAnnouncementsPageProps {
  params: {
    id: string
  }
}

export default async function ProgramAnnouncementsPage({ params }: ProgramAnnouncementsPageProps) {
  const { id } = params
  ...
  return (
    <div className="space-y-6">
      ...
      <AnnouncementList programId={id} isTeacher={isTeacher} />
    </div>
  )
}
